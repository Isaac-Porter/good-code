...
double WHEEL_RADIUS = 2.75/2;
double MOTOR_CONSTANT = 0.975;
...
double LTrackRadius = 6.5; 
double RTrackRadius = 6.5; 
double STrackRadius = 0.5;
...
int positionTracking() {
  while(1) {
    ...
    deltaDistL = ((LPos - LPrevPos) * M_PI / 180) * MOTOR_CONSTANT;
    deltaDistR = ((RPos - RPrevPos) * M_PI / 180) * MOTOR_CONSTANT;
